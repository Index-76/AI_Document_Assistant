...
class _ConfigDialogState extends State<ConfigDialog> {
  ...
  Future<void> _loadConfig() async {
    try {
      ...
      setState(() {
        ...
        // 数据库配置
        _databaseUrlController = TextEditingController(text: '');
        _databaseUsernameController = TextEditingController(text: '');
        _databasePasswordController = TextEditingController(text: '');
        _databaseNameController = TextEditingController(text: '');
        _databaseTableNameController = TextEditingController(text: '');
        _databaseTypeController = TextEditingController(text: '');
        _isLoading = false;
      });
  ...
  Future<void> _saveConfig() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final success = await ApiService.updateConfig(configData);
      if (success) {
        if (mounted) {
